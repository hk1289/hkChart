...
public class HkLabels {
    ...
    public HkLabels align(String prop) {
        align = prop;
        return this;
    }

    public HkLabels autoRotation(Object prop) {
        autoRotation = prop;        
        return this;
    }

    public HkLabels autoRotationLimit(Number prop) {
        autoRotationLimit = prop;
        return this;
    }

    public HkLabels distance(Number prop) {
        distance = prop;
        return this;
    }

    public HkLabels enabled(Boolean prop) {
        enabled = prop;
        return this;
    }

    public HkLabels format(String prop) {
        format = prop;
        return this;
    }

    public HkLabels formatter(String prop) {
        formatter = HkJSStringPurer.pureAnonymousJSFunctionString(prop);
        return this;
    }

    public HkLabels padding(Number prop) {
        padding = prop;
        return this;
    }

    public HkLabels rotation(Number prop) {
        rotation = prop;
        return this;
    }

    public HkLabels staggerLines(Integer prop) {
        staggerLines = prop;
        return this;
    }

    public HkLabels step(Integer prop) {
        step = prop;
        return this;
    }

    public HkLabels style(HkStyle prop) {
        style =  prop;
        return this;
    }

    public HkLabels x(Number prop) {
        x = prop;
        return this;
    }

    public HkLabels y(Number prop) {
        y = prop;
        return this;
    }

    public HkLabels useHTML(Boolean prop) {
        useHTML = prop;
        return this;
    }
}
